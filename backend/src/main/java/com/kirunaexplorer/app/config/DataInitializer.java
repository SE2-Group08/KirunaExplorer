...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Area area2 = areaRepository.save(new Area(
            ...
            new Geometry(GeometryType.POLYGON, List.of(new Coordinates(68.0, 21.0), new Coordinates(68.5, 21.5), new Coordinates(68.8, 21.8)))
        ));
        ...
        geoReferenceRepository.save(new GeoReference(document3, area2, null));
        ...
        geoReferenceRepository.save(new GeoReference(document4, null, point2));
        ...
        // "This document is a compilation of the responses to the survey 'What is your
        // impression of Kiruna?' From the citizens' responses to this last part of the
        // survey, it is evident that certain buildings, such as the Kiruna Church, the
        // Hjalmar Lundbohmsgärden, and the Town Hall, are considered of significant
        // value to the population. The municipality views the experience of this survey
        // positively, to the extent that over the years it will propose various
        ...
        // aimed at transforming the residential areas into mining industry zones to
        // allow the demolition of buildings. The area includes the town hall, the
        // Ullspiran district, and the AlO highway, and it will be the first to be
        // dismantled. The plan consists, like all detailed plans, of two documents: the
        // area map that regulates it, and a text explaining the reasons that led to the
        // drafting of the plan with these characteristics. The plan gained legal
        // validity in 2012.",
        // "Kiruna kommun",
        // "Prescriptive document",
        // "1:8000",
        ...
        // document2,
        // false,
        // geometryFactory.createPoint(new Coordinate(20.2732, 67.8558)) // Specific
        // location
        // );
        ...
        // "Development Plan",
        // "The development plan shapes the form of the new city. The document, unlike
        // previous competition documents, is written entirely in Swedish, which
        // reflects the target audience: the citizens of Kiruna. The plan obviously
        // contains many elements of the winning masterplan from the competition, some
        // recommended by the jury, and others that were deemed appropriate to integrate
        // later. The document is divided into four parts, with the third part, spanning
        // 80 pages, describing the shape the new city will take and the strategies to
        // be implemented for its relocation through plans, sections, images, diagrams,
        // and texts. The document also includes numerous studies aimed at demonstrating
        ...
        // document3,
        // false,
        // geometryFactory.createPoint(new Coordinate(20.3201, 67.8514)) // Specific
        // location
        // );
        ...
        // "This document is the update of the Development Plan, one year after its
        // creation, modifications are made to the general master plan, which is
        // published under the name Adjusted Development Plan91, and still represents
        // the version used today after 10 years. Certainly, there are no drastic
        // differences compared to the previous plan, but upon careful comparison,
        // several modified elements stand out. For example, the central square now
        // takes its final shape, as well as the large school complex just north of it,
        ...
        // document5,
        // false,
        // geometryFactory.createPoint(new Coordinate(20.3385, 67.8344)) // Specific
        // location
        // );
        ...
        // "This plan, approved in July 2016, is the first detailed plan to be
        // implemented from the new masterplan (Adjusted development plan). The document
        // defines the entire area near the town hall, comprising a total of 9 blocks
        // known for their density. Among these are the 6 buildings that will face the
        // main square. The functions are mixed, both public and private, with
        // residential being prominent, as well as the possibility of incorporating
        // accommodation facilities such as hotels. For all buildings in this plan, the
        // only height limit is imposed by air traffic.",
        // "Kiruna kommun",
        // "Prescriptive document",
        // "1:1000",
        ...
        // "After two extensions of the land acquisition agreement, necessary because
        // this document in Sweden is valid for only two years, construction of the
        // hotel finally began in 2019.",
        // "LKAB",
        // "Material effect",
        // "Blueprint/Material effects",
        // LocalDate.of(2019, 4, 19),
        ...
        // document7,
        // false,
        // geometryFactory.createPoint(new Coordinate(20.2500, 67.9000)) // Specific
        // location
        // );
