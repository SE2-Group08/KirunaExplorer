...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        var kirunaKommunStakeholder = new Stakeholder("Kiruna kommun");
        var residentsStakeholder = new Stakeholder("Residents");
        var whiteArkitekterStakeholder = new Stakeholder("White Arkitekter");
        var lkabStakeholder = new Stakeholder("LKAB");

        stakeholderRepository.save(kirunaKommunStakeholder);
        stakeholderRepository.save(residentsStakeholder);
        stakeholderRepository.save(whiteArkitekterStakeholder);
        stakeholderRepository.save(lkabStakeholder);
        ...
        Document document1 = new Document(null,
            ...
            List.of(kirunaKommunStakeholder, residentsStakeholder),
        ...
        Document document2 = new Document(null,
            ...
            List.of(kirunaKommunStakeholder),
        ...
        Document document3 = new Document(null,
            ...
            List.of(kirunaKommunStakeholder, whiteArkitekterStakeholder),
            "Design document",
            "1:7500",
